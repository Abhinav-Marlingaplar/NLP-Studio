    ...
    <div className="min-h-screen flex items-center justify-center px-4 relative"
      ...
      <motion.div initial="hidden" animate="visible" variants={fadeUp} transition={{ duration: 0.6 }}
        ...
        <motion.h2 variants={fadeUp} transition={{ delay: 0.2 }}
                   className="font-display text-3xl font-bold text-white text-center mb-2">
          Welcome Back
        </motion.h2>
        ...
        {/* Footer link */}
        <motion.p variants={fadeUp} transition={{ delay: 0.54 }}
                  className="text-center text-xs mt-6 font-light"
                  style={{ color: 'rgba(255,255,255,0.35)' }}>
          New here?{" "}
          <Link to="/register" style={{ color: '#F5C842' }}
